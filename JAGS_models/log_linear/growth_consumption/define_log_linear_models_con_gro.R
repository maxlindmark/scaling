...
}", fill = TRUE, file = "JAGS_models/log_linear/growth_consumption/m1.txt")
...
cat(
  ...
  }", fill = TRUE, file = "JAGS_models/log_linear/growth_consumption/m2.txt")
...
cat(
  ...
  }", fill = TRUE, file = "JAGS_models/log_linear/growth_consumption/m3a.txt")
...
cat(
  ...
  }", fill = TRUE, file = "JAGS_models/log_linear/growth_consumption/m3b.txt")
...
cat(
  ...
  }", fill = TRUE, file = "JAGS_models/log_linear/growth_consumption/m4.txt")
...
cat(
  ...
  }", fill = TRUE, file = "JAGS_models/log_linear/growth_consumption/m5.txt")
...
cat(
  ...
  }", fill = TRUE, file = "JAGS_models/log_linear/growth_consumption/m6a.txt")
...
cat(
  ...
  }", fill = TRUE, file = "JAGS_models/log_linear/growth_consumption/m6b.txt")
...
cat(
  ...
  }", fill = TRUE, file = "JAGS_models/log_linear/growth_consumption/m7.txt")
