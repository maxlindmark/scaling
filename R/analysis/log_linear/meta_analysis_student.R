...
#
# - Code to fit hierarchical model of metabolic rate as a function of temperature and mass
# 
...
#                        variable.names = c("b0", "b1", "b2", "b3", "k",
#                                           "mu_b0", "mu_b1", "mu_b2",
...
#                                          axis.text = element_text(size = 5))
# pWord1a + pWord2a
# ggsave("figures/supp/log_linear/met_con/validation_met_intercepts_1.2_student.png", width = 6.5, height = 6.5, dpi = 600)
# 
# 
...
#                                          axis.text = element_text(size = 5))
# pWord1b + pWord2b
# ggsave("figures/supp/log_linear/met_con/validation_met_intercepts_2.2_student.png", width = 6.5, height = 6.5, dpi = 600)
# 
# 
...
#                                          axis.text = element_text(size = 5))
# pWord3a + pWord4a
# ggsave("figures/supp/log_linear/met_con/validation_met_mass_1.2_student.png", width = 6.5, height = 6.5, dpi = 600)
# 
# 
...
#                                          axis.text = element_text(size = 5))
# pWord3b + pWord4b
# ggsave("figures/supp/log_linear/met_con/validation_met_mass_2.2_student.png", width = 6.5, height = 6.5, dpi = 600)
# 
# 
...
#                                          axis.text = element_text(size = 5))
# pWord5a + pWord6a
# ggsave("figures/supp/log_linear/met_con/validation_met_temp_1.2_student.png", width = 6.5, height = 6.5, dpi = 600)
# 
# 
...
#                                          axis.text = element_text(size = 5))
# pWord5b + pWord6b
# ggsave("figures/supp/log_linear/met_con/validation_met_temp_2.2_student.png", width = 6.5, height = 6.5, dpi = 600)
# 
# 
# #**** Group-level means ============================================================
...
#                                        axis.text = element_text(size = 5))
# pWord7 + pWord8
# ggsave("figures/supp/log_linear/met_con/validation_met_student.png", width = 6.5, height = 6.5, dpi = 600)
# 
# 
...
#                                        axis.text = element_text(size = 5))
# ggsave("figures/supp/log_linear/met_con/validation_rhat_met_student.png", width = 6.5, height = 6.5, dpi = 600)
# 
# 
# #**** Prior vs posterior ===========================================================
...
# png(file = "/Users/maxlindmark/Desktop/R_STUDIO_PROJECTS/scaling/figures/supp/log_linear/met_con/validation_prior_post_met_student.png", 
...
#   NULL
# 
# ggsave("figures/supp/log_linear/met_con/fit_met_mean_student.png", width = 6.5, height = 6.5, dpi = 600)

# Residuals
# Extract posteriors for each data point for calculation of residuals
resid <- coda.samples(jm_met, variable.names = c("y_sim", "k"), n.iter = n.iter, thin = thin, )
...
ggsave("figures/supp/log_linear/met_con/resid_met_student.png", width = 6.5, height = 6.5, dpi = 600)
