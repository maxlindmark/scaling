...
cat(
  ...
  }", fill = TRUE, file = "R/analysis/JAGS_models/non_linear_model/non_linear_model1.txt")
...
cat(
  ...
  }", fill = TRUE, file = "R/analysis/JAGS_models/non_linear_model/non_linear_model1b.txt")
...
cat(
  ...
  }", fill = TRUE, file = "R/analysis/JAGS_models/non_linear_model/non_linear_model1c.txt")
...
cat(
  ...
  }", fill = TRUE, file = "R/analysis/JAGS_models/non_linear_model/non_linear_model1d.txt")
...
cat(
  ...
  }", fill = TRUE, file = "R/analysis/JAGS_models/non_linear_model/non_linear_model2.txt")
