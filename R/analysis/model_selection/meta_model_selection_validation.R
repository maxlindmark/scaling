...
ggplot(dat, aes(log_mass_norm_ct, log(y), color = temp_norm_arr_ct)) + 
  ...
  labs(x = "ln(standardized mass)",
       ...
       color = "Standardized\nArrhenius\ntemperature") +
  NULL
#ggsave("figs/supplement/consumption_mass_scatter.pdf", plot = last_plot(), scale = 1, width = 14, height = 14, units = "cm", dpi = 300)
...
ggplot(dat, aes(temp_norm_arr_ct, log(y), color = log_mass_norm_ct)) + 
  ...
  NULL
#ggsave("figs/supplement/consumption_temp_scatter.pdf", plot = last_plot(), scale = 1, width = 14, height = 14, units = "cm", dpi = 300)
...
}", fill = TRUE, file = "R/analysis/m1_cons.txt")

model = "R/analysis/m1_cons.txt"
...
cat(
  ...
  }", fill = TRUE, file = "R/analysis/m2_consumption.txt")

model = "R/analysis/m2_consumption.txt"
...
cat(
  ...
  }", fill = TRUE, file = "R/analysis/m3_consumption.txt")

model = "R/analysis/m3_consumption.txt"
...
cat(
  ...
  }", fill = TRUE, file = "R/analysis/m4_consumption.txt")

model = "R/analysis/m4_consumption.txt"
