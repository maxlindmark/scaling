...
model1 = "R/analysis/JAGS_models/polynomial/polynomial_model1.txt"
...
model1b = "R/analysis/JAGS_models/polynomial/polynomial_model1b.txt"
...
model1c = "R/analysis/JAGS_models/polynomial/polynomial_model1c.txt"
...
model1d = "R/analysis/JAGS_models/polynomial/polynomial_model1d.txt"
...
model2 = "R/analysis/JAGS_models/polynomial/polynomial_model2.txt"
...
pWord2 <- p2 + theme_classic() + theme(text = element_text(size = 10),
                                       axis.text = element_text(size = 5))
pWord1 + pWord2
ggsave("figures/supp/polynomial/validation_poly_intercepts.png", width = 6.5, height = 6.5, dpi = 600)
...
pWord4 <- p4 + theme_classic() + theme(text = element_text(size = 10),
                                       axis.text = element_text(size = 5))
pWord3 + pWord4
ggsave("figures/supp/polynomial/validation_poly.png", width = 6.5, height = 6.5, dpi = 600)
...
ggsave("figures/supp/polynomial/validation_rhat_poly.png", width = 6.5, height = 6.5, dpi = 600)
...
y_sim <- coda.samples(jm1c, variable.names = c("y_sim"), n.iter = n.iter, thin = thin)
...
p_resid <- ggplot(resid_df, aes(yhat, resid_st)) +
...
ggsave("figures/supp/polynomial/fit_pp_resid_gro.png", width = 7, height = 7, dpi = 600)
...
ggsave("figures/supp/polynomial/polynomial_con.png", width = 6.5, height = 6.5, dpi = 600)
